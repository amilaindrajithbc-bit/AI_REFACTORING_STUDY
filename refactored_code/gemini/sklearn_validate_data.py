def validate_data(
    ...
    **check_params,
    ...
    X : {array-like, sparse matrix, dataframe} of shape \
        ...
        useful for meta-estimators which can delegate input validation to
    ...
    **check_params : kwargs
    ...
    if skip_check_array:
        ...
        # Some estimators validate X and y separately; separately calling
        # check_array() on X and y isn't always equivalent to check_X_y().
