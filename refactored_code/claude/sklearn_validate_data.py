def validate_data(
    ...
    **check_params : kwargs
    ...
    out : {ndarray, sparse matrix} or tuple of these
        ...
        validated.
    """
    # Set or check `feature_names_in_` based on the estimator's tags and
    # the provided X.
    ...
    # Determine whether X and/or y should be skipped from validation.
    ...
    # Ensure `estimator` is included so that check_array/check_X_y can
    # produce more informative error messages.
    default_check_params = {"estimator": _estimator}
    check_params = {**default_check_params, **check_params}

    if skip_check_array:
        # Only feature name/count checks are performed; X and y are
        # returned unchanged.
    ...
    # Set or check `n_features_in_` unless X was skipped or explicitly
    # not required to be 2D.
